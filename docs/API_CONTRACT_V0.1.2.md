# QMI Web API Contract v0.1.2

This contract describes the same-origin API used by the Vue WebUI. It is derived from `internal/api/RouteContracts` and the checked-in route inventory at [`reports/routes-v0.1.2.txt`](../reports/routes-v0.1.2.txt).
